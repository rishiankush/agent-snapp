...
class WorkerSetting extends Component {
  constructor(props) {
    super(props);
    this.state = {
      jobshowArrow : false,
  ...
  expandSetting(type){
    ...
    switch(type){
      case 'job': 
      this.setState({
        jobshowArrow : !this.state.jobshowArrow
      })
      break;

      case 'distance': 
      this.setState({
        distanceshowArrow : !this.state.distanceshowArrow
      })
      break;

      case 'hRate': 
      this.setState({
        HRateshowArrow : !this.state.HRateshowArrow
      })
      break;
    }
...
export default withRouter(WorkerSetting);
